...
"memoryview(object, remote=False)\n"
"--\n"
"\n"
...
memoryview(PyTypeObject *type, PyObject *args, PyObject *kwargs)
{
    ...
    static struct {
        ...
        .ob_item = { &_Py_ID(object), &_Py_ID(remote), },
    };
    #undef NUM_KEYWORDS
    ...
    static const char * const _keywords[] = {"object", "remote", NULL};
...
skip_optional_pos:
    return_value = memoryview_impl(type, object, remote);
...
/*[clinic end generated code: output=9fc46de99f4ec05d input=a9049054013a1b77]*/
